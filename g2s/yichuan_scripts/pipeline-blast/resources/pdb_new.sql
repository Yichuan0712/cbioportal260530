...
CREATE TABLE `uniprot_entry`(
    `UNIPROT_ID_ISO` VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
    `UNIPROT_ID` VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
    `NAME` VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
    `ISOFORM` VARCHAR(8) NOT NULL,
    `SEQ_ID` int(255),
...
CREATE TABLE `ensembl_entry` (
    ...
    `ENSEMBL_GENE` VARCHAR(32),
    `ENSEMBL_TRANSCRIPT` VARCHAR(32),
    `SEQ_ID` int(255),
